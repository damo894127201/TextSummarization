...
class AttentionDecoder(nn.Module):
    def __init__(self,embedding_size,hidden_size,output_size,BertModel,keep_prob):
    ...
    def forward(self,input,pre_hidden,Encoder_outputs,flag=True):
        ...
        embeddings = self.BertModel(input)[0]
        ...
        # 加一层激活函数，作为各个维度的门,但不改变形状，只改变各维度的值[batch_size,max_time_step,1]

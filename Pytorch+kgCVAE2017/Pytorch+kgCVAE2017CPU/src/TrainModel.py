...
if __name__ == '__main__':
    ...
    for epoch in range(config.num_Epochs):
        for iter,(batch_x,batch_y,batch_source_lens,batch_target_lens,batch_size,descendingOrders,source_article_lens) in enumerate(loader):
            ...
            outputs,KL_loss,mlp_outputs = model(batch_x,batch_source_lens,batch_y,batch_target_lens,batch_size,descendingOrders,source_article_lens,config.TeacherForcingRate)

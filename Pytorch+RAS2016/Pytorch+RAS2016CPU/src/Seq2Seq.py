...
class Seq2Seq(nn.Module):
    ...
    def __init__(self,config):
        ...
        self.B_matrix = Variable(torch.Tensor(self.num_filters,config.q_size,config.embedding_size).uniform_(-1,1),requires_grad=True) # 初始化B矩阵，公式(2)
        # 初始化encoder和decoder
    ...
    def BatchSample(self,source,source_lens):
        ...
        for i in range(batch_size):
            ...
            cell_state = cell_state.view(1,1,-1) # [1,1,hidden_size*2]

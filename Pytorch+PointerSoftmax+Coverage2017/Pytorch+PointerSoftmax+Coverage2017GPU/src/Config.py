...
class Config(object):
    vocab_size = 5004  #词包大小还得加上这些特殊符号："_PAD": 0, "_GO": 1, "_EOS": 2, "_UNK": 3
    embedding_size = 128
    hidden_size = 128
    output_size = 5004
    ...
    ratio = 0.2 # Coverage 损失 的权重
                # we use hyperparameter λ to weight our coverage loss, and
                # get a new composite loss function